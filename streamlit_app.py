    ...
    css_styles="""
        ...
        if not st.session_state['table_string_butt']:
          ...
          #  show_custom_boxz = popover.checkbox('Holiday Cup', on_change=upd_cust1, key='sho_cust1')
            ...
            show_custom_boxz3 = popover.checkbox('Love Cup', value=st.session_state['show_custom2'], on_change=upd_cust2, key='sho_cust1')
          ...
          #  show_custom_boxz2 = popover.checkbox('Holiday Cup', on_change=upd_cust1, key='sho_cust1')
            show_custom_boxz3 =  popover.checkbox('Love Cup String', value=st.session_state['show_custom2'], on_change=upd_cust2, key='sho_cust1')
